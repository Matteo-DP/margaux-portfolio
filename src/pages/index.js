      ...
      <div className='flex justify-center mb-32 px-8 pt-32' id="about">
        <div className='max-w-[1000px]'>
          ...
          <p className='font-quicksand text-zinc-700 text-justify inline-block first-letter:text-2xl first-letter:text-red-400'>
            ...
            For Margaux, a painting can rarely start without a colour study. 
            For her, colour and space are enormously close. 
            So understanding colours is essential. 
            She often starts a painting on the ground. 
            This way, intuition and movement can help determine the composition. 
            While painting, Margaux constantly questions the limitations of her medium: how can you depict a space without adhering to conventions? 
            The creation of a new painting is each time a reinvention of herself and the world. 
